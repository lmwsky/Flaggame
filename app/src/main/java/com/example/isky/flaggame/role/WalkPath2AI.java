 ...
 * 沿着给定的路径进行移动
 */
public class WalkPath2AI implements AI {
    /**
    ...
    public WalkPath2AI(LatLng latLng, List<WalkStep> walkStepList, String roleSignSignature) {
    ...
    private void ComputeInitGoal() {
        int index = calculateShortestPoint(walkStepList, nowLocation);
        goal_indexinwalksteplist = index;
        goal_indexinPolyLine = 0;
