...
public class GameConfig {
    ...
    public static final int ROLE_MINER = 0;
    public static final int ROLE_SAPPER = 1;
    public static final int ROLE_SCOUT = 2;
    public static final int BITMAP_SKILL_MINER = R.drawable.icon_skill_miner;
    public static final int BITMAP_SKILL_SAPPER = R.drawable.icon_skill_sapper;
    public static final int BITMAP_SKILL_SCOUT = 0;
